...
const CalendarScreen = () => {
  ...
  const eventStyleGetter = (event, _start, _end, _isSelected) => {
    // Use optional chaining to avoid the error if event.user is null or undefined
    const style = {
      backgroundColor: event.user?._id === id ? "#367CF7" : "#465660", // Optional chaining to safely check _id
      opacity: 0.8,
      display: "block",
      color: "white",
    };
